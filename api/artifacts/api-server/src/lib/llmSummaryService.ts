...
import { OPENAI_LLM_SUMMARY_MODEL } from "../config.js";
import { invalidateSummary } from "./summaryCache.js";
import type { Logger } from "pino";

const openai = new OpenAI({ apiKey: process.env.OPENAI_LLM_API_KEY });
